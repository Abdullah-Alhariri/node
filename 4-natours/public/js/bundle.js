...
module.exports = {
  ...
  "_spec": "axios",
  "_where": "G:\\1udemy-courses\\[FreeCourseSite.com] Udemy - Node.js, Express, MongoDB & More The Complete Bootcamp 2020\\myCode\\4-natours",
  "author": {
    "name": "Matt Zabriskie"
  },
  "browser": {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            res = _context2.sent;
            if (res.data.status = 'success') location.reload(true); //true foces a reload from the server
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJkdWxsYWgtYWxoYXJpcmkiLCJhIjoiY2t0c2s5c3o2MDdtZzJwb2RzYXVrNWh2OSJ9.lkR3rQJ5w8_-HHEpQTL75w';
  ...
  var bounds = new mapboxgl.LngLatBounds(); // 'mapboxgl.LatLngBounds' comes from block append head scripts
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(type), " updated successfully!"));
            }
...
var stripe = Stripe('pk_test_51IpkfuKpVZUPOvJ7n9TuB4VDWPAeXB8q0Hz9sWcll1yCewKsUZ5zUvSU2mAb7Lkkm0U3ShBwVoyCvvNv4uuWBuhL00z4IcmDsD');
...
var bookBtn = document.getElementById('book-tour'); // Checking if map id exist, if so render the map
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14679" + '/');
